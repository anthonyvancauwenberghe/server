...
public class DialogueManager {
        ...
        switch(dialogueId){
            ...
            case 1:
                if(player.bankPin != null && !player.bankPin.equals("null")){
                    player.getActionSender().sendDialogue("Select an option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "I'd like to access my bank account, please.", "I'd like to change my PIN please.");
                }else{
                    player.getActionSender().sendDialogue("Select an option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "I'd like to access my bank account, please.", "I'd like to set my PIN please.");
                }
            ...
            case 3:
                if(player.bankPin != null && !player.bankPin.equals("null")){
                    player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I'd like to change my PIN please.");
                }else{
                    player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I'd like to set my PIN please.");
                }
            ...
            case 4:
                ...
                break;
            case 5:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Bandit Camp", "Soul's Bane Dungeon.", "Master Area", "More");
            ...
            case 8:
                ...
                break;
            case 9://more
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Asgarnian Ice Dungeon", "Brimhaven Dungeon.", "Taverly Dungeon", "Next");
                ...
                break;
            case 13:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Duel Arena", "Barrows Minigame", "GodWars", "Thzaar");
            ...
            case 17:
                ...
                break;
            case 18:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Hello, welcome to " + Server.NAME + ", Please ensure you are active", "on the forums to keep updated with whats new.");
                player.getInterfaceState().setNextDialogueId(0, 19);
                break;
            case 19:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "To get to the main cities you may use your spellbook,", "however in order to train or visit minigames", "you must use your glory and ring of dueling.");
                player.getInterfaceState().setNextDialogueId(0, 20);
                break;
            case 20:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "You may begin your adventure by visiting barberian village", "and start training.");
            ...
            /*player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT,
                ...
                break;
            case 22:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "You already have a Slayer Task!", "Is this one too difficult?");
                player.getInterfaceState().setNextDialogueId(0, 23);
                break;
            case 23:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes I need a new one.", "No I just forgot what it was.");
                player.getInterfaceState().setNextDialogueId(0, 24);
                player.getInterfaceState().setNextDialogueId(1, 26);
                break;
            case 24:
                if(player.slayerCooldown <= 0){
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Haha Your incomptence mocks me,", "So to regain some respect heres a new task.");
                    player.getInterfaceState().setNextDialogueId(0, 25);
                }else{
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Keep trying at your current task,", "I'm sure you can do it!");
                }
                break;
            case 25:
                player.slayerTask = 0;
                break;
            case 26:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Your current task is to kill " + player.slayerAm, NPCDefinition.forId(player.slayerTask).getName().toLowerCase() + "'s.");
                player.getInterfaceState().setNextDialogueId(0, 27);
                break;
            case 27:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Thanks for your help.");
                break;
            case 28:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Hi, How may I help you?");
                player.getInterfaceState().setNextDialogueId(0, 29);
                break;
            case 29:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I'm looking for a master in the slayer skill.", "Do you know any around here?");
                player.getInterfaceState().setNextDialogueId(0, 30);
                break;
            case 30:
                if(npc != null){
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Yes I do, Infact you've already found him.", "I'm the current grandmaster in slayer in all of glenior.");
                    player.getInterfaceState().setNextDialogueId(0, 31);
                }
                break;
            case 31:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Could you give me a task to improve my slayer abilities?", "No sorry I think I have the wrong person.");
                player.getInterfaceState().setNextDialogueId(0, 32);
                player.getInterfaceState().setNextDialogueId(1, 27);
                break;
            case 32:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Sure no problem, Now lets find a task,", "worthy of a warrior like yourself.");
                player.getInterfaceState().setNextDialogueId(0, 25);
                break;
            case 33:
                player.getActionSender().sendDialogue("Slayer Master", DialogueType.NPC, 1599, FacialAnimation.DEFAULT, "Congratulations on completing your slayer task!", "Come see me whenever you would like a new one.");
                break;
            case 34://more
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Rock Crabs", "Greater Demons", "Back");
            ...
            case 36:
                ...
                break;
            case 37:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Hello " + player.getName() + ", I see that you are new here.");
                player.getInterfaceState().setNextDialogueId(0, 38);
                break;
            case 38:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Yes, I am can you please tell me how can I get to the main land?");
                player.getInterfaceState().setNextDialogueId(0, 39);
                break;
            case 39:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Not so fast young one, ", "you have to know the basics before i let you leave this place");
                player.getInterfaceState().setNextDialogueId(0, 40);
                break;
            case 40:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Sure, just tell me what i have to do and i'll get it done.");
                player.getInterfaceState().setNextDialogueId(0, 41);
                break;
            case 41:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Right, i have a small task for you....");
                player.getInterfaceState().setNextDialogueId(0, 64);
                break;
            case 64:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "I need you to find my guide book", "Its around here somewhere.");
                player.getInterfaceState().setNextDialogueId(0, 42);
                break;
            case 42:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Can you do this for me?");
                player.getInterfaceState().setNextDialogueId(0, 43);
                break;
            case 43:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Sure, i'm on it.");
                player.tutIsland = 2;
                break;
            case 44:
                if(ContentEntity.isItemInBag(player, 1856)){
                    ...
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Can't you find the book!?,", "well you cant leave till it's found...");
                break;
            case 45:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Well done " + player.getName() + ", now please", "read the guide to understand basic infomation about " + Server.NAME);
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 46:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Ok, thanks can i leave now?");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 47:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Not just yet, the main land is a dangerous place,", "you need to learn basic combat before i let you leave", "so you can defend yourself");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 48:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "ahh, fine tell me what i have to do now..");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 49:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Here take these combat items");
                ...
                break;
            case 50:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Go next door and kill the chickens,", "once you kill them bring me the chicken");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 51:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Right.... will do it right away");
                player.tutSubIsland = 0;
                player.tutIsland = 5;
                break;
            case 52:
                if(ContentEntity.isItemInBag(player, 2138)){
                    ...
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Too tough for you?", "sorry you can't leave till this is done");
                }
                break;
            case 53:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Ah, great job", "you may now leave to the main land");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 54:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "Alright cool! but before i leave can i get some food");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 55:
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I'm kind of hungery");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 56:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "well sure, take this axe,", "tinderbox and cook the meat you got");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
            ...
            case 57:
                if(!ContentEntity.isItemInBag(player, 2140)){
                    player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I'm still hungry, I better find some food soon.");
                }else{
                    player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I feel much better now that I have eaten");
                    player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                }
                break;
            case 58:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Good, you may now leave,", "if you need help later on use the guide book");
                player.getInterfaceState().setNextDialogueId(0, dialogueId + 1);
                break;
            case 59:
                player.tutIsland = 10;
                ...
                player.getActionSender().openQuestInterface(Server.NAME + " Guide Book", new String[]{
                        "Congratulations on Completeing the begineers", "Tutorial you can now read your guide book",
                        "To learn how to get started.", "on " + Server.NAME + ".com",});
                player.getSkills().reset();
                player.getActionSender().sendSkills();
                break;
            case 60://1,3,4,6
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I need to talk to the guide.");
                break;
            case 61://2
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I need to find the book to give it to the guide.");
                break;
            case 62://5
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I need to kill some chickens", "To get some meat for the guide.");
                break;
            case 63://7
                player.getActionSender().sendDialogue(player.getName(), DialogueType.PLAYER, -1, FacialAnimation.DEFAULT, "I need to use my axe to chop the trees next door,", "make a fire and cook the raw chicken i have");
                break;
            case 65:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "I found a Secret Crypt, I'm going in!", "This secret crypt looks scary, ill come back later.");
            ...
            case 67:
                ...
                break;
            case 68:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Teleport me to Tzhaar!", "Nah, ill come back later.");
 ...
 the coords for that will be on barb village bridge to varrock
            ...
            case 70:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Experiments", "Taverly Dungeon", "Slayer Tower", "Brimhaven Dungeon", "Hill Giants");
            ...
            case 75:
                ...
                break;
            case 76:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Barrows", "Tzhaar Caves", "Duel Arena", "Warriors Guild", "Ranging Guild");
            ...
            case 80:
                ...
                break;
            case 81:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Godwars", "King Black Dragon (Wild)", "Dagannoth Kings", "Chaos Elemental (Wild)", "Corporal Beast");
            ...
            case 87:
                ...
                break;
            case 88:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Lumbridge", "Varrock", "Edgeville", "Falador", "Camelot");
            ...
            case 93:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Mage Bank", "Edgeville Dragons", "Mid Wilderness", "Chaos Altar", "Fun Pk (Safe)");
            ...
            case 98:
                ...
                break;
            case 100:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Mining", "Smithing", "Fishing/Cooking", "Agility", "Farming/Woodcutting");
            ...
            case 105:
                ...
                break;
            case 106:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Multi Arena (Safe)", "Singles (Safe)");
            ...
            case 109:
                ...
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Ranged Pure", "Hybrid Pure", "Berserker Pure", "Main", "Skiller");
            ...
            case 115:
                ...
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Flux Account", "DeviousPK Account");
            ...
            case 117:
                break;
            case 118:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Hello, Do you want to exchange your", "implings for rewards?");
                player.getInterfaceState().setNextDialogueId(0, 119);
                break;
            case 119:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes please", "No thank you");
            ...
            case 120:
                ...
                break;
            case 121:
                player.getActionSender().sendDialogue("Select a Spellbook", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Modern Spellbook", "Ancient Spellbook");
            ...
            case 123:
                ...
                break;
            case 124:
                player.getActionSender().sendDialogue("Talk About", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Ranging Minigame", "Ranging SkillCape");
                player.getInterfaceState().setNextDialogueId(0, 125);
                player.getInterfaceState().setNextDialogueId(1, 128);//TODO
                break;
            case 125:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Hi, Do you want ", "to play a game?", "You might win cool awards!");
                player.getInterfaceState().setNextDialogueId(0, 126);
                break;
            case 126:
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "All you have to do ", "is fire these targets!", "To enter you must pay 5000 gp");
                player.getInterfaceState().setNextDialogueId(0, 127);
                break;
            case 127:
                player.getActionSender().sendDialogue("Do you want to play?", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes sure", "Sorry, maybe later");
            ...
            case 130:
                if(npc != null)
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Hello there, I am the dice game hoster.", "If I throw 55 or higher I'll double your item!", "But if I throw less than 55, you'll lose your item!");
                player.getInterfaceState().setNextDialogueId(0, 131);
                break;
            case 131:
                if(npc.getDefinition() != null){
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "To play, simply give an item to me.", "@dre@(Use the item of the gambler)");
            ...
            case 132:
                ...
                player.getActionSender().sendDialogue("Santa Claus", DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Ho Ho Ho", "Visit me on Christmas for a special gift!");
                player.getInterfaceState().setNextDialogueId(0, -1);
                break;
            case 133:
                player.getActionSender().sendDialogue("Santa Claus", DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "I need you to catch", "20 implings", "to help the world out!");
                player.getInterfaceState().setNextDialogueId(0, 134);
                break;
            case 134:
                player.getActionSender().sendDialogue("Will you do this?", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes I will", "Sorry, maybe later");
                player.getInterfaceState().setNextDialogueId(0, -1);//TODO
                break;
            case 135:
                player.getActionSender().sendDialogue("Santa Claus", DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Enjoy your surprise!");
                player.getInterfaceState().setNextDialogueId(0, -1);//TODO
                break;
            case 136:
                player.getActionSender().sendDialogue("Moderation Options", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Kick", "Jail", "Mute");
            ...
            case 139:
                ...
                break;
            case 140:
                player.getActionSender().sendDialogue("Sir", DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Hello I'm the master of PvP Tasks!", "Would you like a task?");
                player.getInterfaceState().setNextDialogueId(0, 141);//TODO
                break;
            case 141:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes!", "No...");
            ...
            case 142:
                if(player.getPvPTask() == null || player.getPvPTaskAmount() <= 0){
                    ...
                    player.getActionSender().sendDialogue("Sir", DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "I've assigned you " + player.getPvPTaskAmount() + " " + PvPTask.toString(player.getPvPTask()) + "s to kill!");
                }else{
                    player.getActionSender().sendDialogue("Sir", DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "You still have " + player.getPvPTaskAmount() + " " + PvPTask.toString(player.getPvPTask()) + "s to kill!");
                }
                player.getInterfaceState().setNextDialogueId(0, -1); //exit
                break;
            case 143:
                player.getActionSender().sendDialogue("Are you sure?", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes, I want to empty my inventory!", "Do not empty my inventory");
                player.getInterfaceState().setNextDialogueId(0, 144);
                player.getInterfaceState().setNextDialogueId(1, -1);
                break;
            case 144:
                for(int i = 0; i < 28; i++){
                    final Item item = player.getInventory().get(i);
                    if(item == null)
                        continue;
                ...
                break;
            case 145:
                player.getActionSender().sendDialogue("You protect 0 items in here!", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes! I'm a brave warrior!", "No...");
            ...
            case 149:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Information", "View bank");
            ...
            case 150:
                ...
                break;
            case 151:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Hybridding Area", "Oldschool Pk Area", "Fun Pk Area", "Pure Pk Area");
            ...
            case 154:
                ...
                break;
            case 155:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Set my levels please!", "I'd like to keep my current levels");
            ...
            case 156:
                ...
                final int[][] skillData = {{Skills.ATTACK, 60}, {Skills.DEFENCE, 1}, {Skills.PRAYER, 52},
                        {Skills.RANGED, 99}, {Skills.MAGIC, 99}};
            ...
            case 162:
                //i know i should declare it outside as prviate static final but 2 lazy
                final int[][] skillDataZ = {{Skills.ATTACK, 75}, {Skills.DEFENCE, 45}, {Skills.PRAYER, 95},};
                if(!player.canSpawnSet())
                    return;
            ...
            case ZombieMinigame.START_DIALOG:
                break;
            case 165:
                player.getActionSender().sendDialogue("Upgrade (" + player.getBHPerks().calcNextPerkCost() + " BHPts)", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Upgrade my perks!", "What are perks?");
            ...
            case 168:
                ...
                break;
            case 169:
                player.getActionSender().sendDialogue("Upgrade (" + player.getBHPerks().calcNextPerkCost() + " BHPts)", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Special Restore", "Veng Time Reduction", "Prayer Leeching");
            ...
            case 170:
                player.getActionSender().removeChatboxInterface();
                player.sendMessage("Special Perk: @blu@Increase special after a kill", "@red@(I) 10% (II) 20% (III) 40%", "Veng Reduction Perk: @blu@Reduce time for next vengeance", "@red@(I) 4seconds (II)8seconds (II)16seconds", "Prayer Leech Perk: @blu@Leech your opponent's prayer (stacks with soulsplit & smite)");
                break;
            case 171:
                player.getActionSender().sendDialogue("BH Master", DialogueType.NPC, 1337, FacialAnimation.DEFAULT, "Your opponent is in deep or multi wilderness...", "Are you sure you want to teleport to him/her?");
                player.getInterfaceState().setNextDialogueId(0, 172);//TODO
                break;
            case 172:
                player.getActionSender().sendDialogue("Upgrade (" + player.getBHPerks().calcNextPerkCost() + " BHPts)", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes", "No");
            ...
            case 173:
                ...
                break;
            case 174:
                player.getActionSender().sendDialogue("Select an option", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "I would like to have a new assignment.", "Remove current slayer task (20 pts).", "I would like to view the slayer store.", "I would like to reset my task progress (lose total task streak + 1 pt).", "I would like to view the PvM Store");
            ...
            case 175:
                ...
                player.getActionSender().sendDialogue("Slayer Master", DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, toDisplay);

                break;
            case 176:
                player.getActionSender().sendDialogue("Are you sure?", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes I'm sure I want to use 20 slayer points", "Nevermind.");
            ...
            case 178:
                ...
                player.getActionSender().sendDialogue("Are you sure?", DialogueType.OPTION, -1, FacialAnimation.DEFAULT, "Yes I'm sure. I want to reset my task progress!", "Nevermind.");
            ...
            case 179: //jack D
                player.getInterfaceState().setNextDialogueId(0, -1);
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Good day " + player.getName() + "! I'm kind of in trouble.", "In order to save thanks-giving I need your help to", "defeat 50 evil chickens, once you've done that", "please come back to me and that speak to me again.");
                break;
            case 180: //jack D
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "You have killed " + player.getTurkeyKills() + " out of " + player.getTurkeyKills() + " evil chickens.", "Speak with me once you have killed 50 of them,", "we must save the thanks-giving after all!");
                player.getInterfaceState().setNextDialogueId(0, 6000);//
                break;
            case 181: //jack D
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "So you managed to kill all the evil chickens, " + player.getName() + "!", "Now the thanks-giving is all safe thanks to you!");
                player.getInterfaceState().setNextDialogueId(0, 182);//
                break;
            case 182: //jack D
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Please accept my reward as a gift,", "it's the least I can do!");
            ...
            case 184: //gala
                if(player.hasFinishedTG()){
                    player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "You have already saved the thanks-giving, " + player.getName() + "!");
                    player.getInterfaceState().setNextDialogueId(0, -1);
                    return;
                }
                player.getActionSender().sendDialogue(npc.getDefinition().getName(), DialogueType.NPC, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "My friend called Grandpa Jack is in need of help.", "I will take you to him for more instructions.");
            ...
            case 188:
                player.getActionSender().sendDialogue("Select an Option", DialogueType.OPTION, npc.getDefinition().getId(), FacialAnimation.DEFAULT, "Exchange my PvP Artifacts for Pk points", "Exchange my Emblems for points", "Open up Emblem point shop");
            ...
            case 189:
                if(EPExchange.exchangeDrops(player))
                    player.getActionSender().sendMessage("You have exchanged your statues.");
                else
                    player.getActionSender().sendMessage("You don't have any statues with you.");
                player.getActionSender().removeChatboxInterface();
                break;
            case 190:
                player.getActionSender().sendDialogue("Are you sure?", DialogueType.OPTION, 1, FacialAnimation.DEFAULT, "Exchange my emblems for " + player.getBountyHunter().emblemExchangePrice() + " emblem points", "Nevermind");
            ...
            case 199:
                ...
                break;
            case 400:
                player.getActionSender().sendDialogue("ArteroPk", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Dear Player, please read carefully...", "InstantPk and ArteroPk have merged the servers!");
                player.getInterfaceState().setNextDialogueId(0, 401);
                break;
            case 401:

                System.out.println("Running code 401");
                player.getActionSender().sendDialogue("ArteroPk", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Your account has been saved but...", "You have to change your name to activate it.", "Please enter a new name in the input box.");
            ...
            case 403:
                player.getActionSender().sendDialogue("ArteroPk", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Unfortunately this name is already taken,", "please choose an other name");
            ...
            case 404:
                ...
                break;
            case 405:
                player.getActionSender().sendDialogue("ArteroPk", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Please remember this username very well,", "@red@next time you have to log in with this new name!", "Please confirm this name.");
                player.getInterfaceState().setNextDialogueId(0, 404);
                break;
            case 406:
                player.getActionSender().sendDialogue("ArteroPk", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "You have entered different usernames.", "Please re-enter your name.");
                player.getExtraData().remove("rename");
                player.getInterfaceState().setNextDialogueId(0, 404);
                break;

            case 500:
                player.getActionSender().sendDialogue("Server", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Dear Player, please read this very carefully...", "You have 2 accounts, one on both ArteroPk and InstantPk.", "One of them can be kept, one must be renamed.");
            ...
            case 504:
                ...
                player.getActionSender().sendDialogue("Server", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Please enter a new name for your", "ArteroPk account.");
            ...
            case 505:
                ...
                break;
            case 506:
                player.getActionSender().sendDialogue("Server", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "You have made an invalid choice, please try again.");
                player.getInterfaceState().setNextDialogueId(0, 501);
            ...
            case 508:
                ...
                player.getActionSender().sendDialogue("Server", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Please enter a new name for your", "InstantPk account.");
            ...
            case 510:
                ...
                break;
            case 511:
                player.getActionSender().sendDialogue("Server", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "Thank you for changing your name!", "You will be logged out now.");
            ...
            case 513:
                //InstantPk
                player.getActionSender().sendDialogue("Server", DialogueType.NPC, 2611, FacialAnimation.DEFAULT, "This name is already in use, please choose an other name.");
                player.getInterfaceState().setNextDialogueId(0, 509);
                break;
            case 514:
                //Artero
            ...
            case 540:
                ...
                break;
            case 541:
                final int currentStreak = player.getPermExtraData().getInt("votingStreak");
    ...
    public static void advanceDialogue(final Player player, final int index) {
        final int dialogueId = player.getInterfaceState().getNextDialogueId(index);
        if(dialogueId == -1){
            player.getActionSender().removeChatboxInterface();
            return;
        }
