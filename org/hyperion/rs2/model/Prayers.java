...
public class Prayers {
    ...
    public static final int[] OVERHEADS = {16, 17, 18, 21, 22, 23, 37, 38, 39};

    /**
     * The prayer id.
     */
    public static final int PRAYER_THICK_SKIN = 0, PRAYER_BURST_OF_STRENGTH = 1, PRAYER_ATTACK_LOW = 2, PRAYER_SHARP_EYE = 3, PRAYER_MAGE_LOW = 4, PRAYER_ROCK_SKIN = 5, PRAYER_SUPERHUMAN_STRENGTH = 6, PRAYER_ATTACK_MID = 7, PRAYER_RAPID_RESTORE = 8, PRAYER_RAPID_HEAL = 9, PRAYER_PROTECT_ITEM = 10, PRAYER_HAWK_EYE = 11, PRAYER_MAGE_MID = 12, PRAYER_TEEL_SKIN = 13, PRAYER_ULTIMATE_STRENGTH = 14, PRAYER_ATTACK_HIGH = 15, PRAYER_PROTECT_FROM_MAGE = 16, PRAYER_PROTECT_FROM_RANGE = 17, PRAYER_PROTECT_FROM_MELEE = 18, PRAYER_EAGLE_EYE = 19, PRAYER_MAGE_HIGH = 20, PRAYER_RETRIBUTION = 21, PRAYER_REDEMPTION = 22, PRAYER_SMITE = 23, PRAYER_CHIVALRY = 24, PRAYER_PIETY = 25, PRAYER_RIGOUR = 26, PRAYER_AUGURY = 27, CURSE_PROTECT_ITEM = 30, CURSE_SAP_WARRIOR = 31, CURSE_SAP_RANGED = 32, CURSE_SAP_MAGE = 33, CURSE_SAP_SPIRIT = 34, CURSE_BERSERKER = 35, CURSE_DEFLECT_SUMMONING = 36, CURSE_DEFLECT_MAGIC = 37, CURSE_DEFLECT_RANGED = 38, CURSE_DEFLECT_MELEE = 39, CURSE_LEECH_ATTACK = 40, CURSE_LEECH_RANGED = 41, CURSE_LEECH_MAGE = 42, CURSE_LEECH_DEFENCE = 43, CURSE_LEECH_STRENGTH = 44, CURSE_LEECH_ENERGY = 45, CURSE_LEECH_SPECIAL = 46, CURSE_WRATH = 47, CURSE_SOULSPLIT = 48, CURSE_TURMOIL = 49, SIZE = 50;


    /**
     * The bonus prayers.
     */
    public static final BonusPrayer[] BONUS_PRAYERS = {new BonusPrayer(PRAYER_THICK_SKIN, Skills.DEFENCE, 1.05),
            ...
            new BonusPrayer(PRAYER_MAGE_LOW, Skills.MAGIC, 1.05), new BonusPrayer(PRAYER_MAGE_MID, Skills.MAGIC, 1.10),
            ...
            new BonusPrayer(PRAYER_PIETY, Skills.STRENGTH, 1.23), new BonusPrayer(PRAYER_RIGOUR, Skills.RANGED, 1.25),
		 ...
		 */
            ...
            //Magic
            new BonusPrayer(CURSE_SAP_MAGE, Skills.MAGIC, 1.05), new BonusPrayer(CURSE_LEECH_MAGE, Skills.MAGIC, 1.15),
            //Attack
     ...
     * The prayers array.
     */
    private final boolean[] prayers;
    /**
     * The leeches queue.
     */
    private final Queue<Integer> leeches = new LinkedList<Integer>();
    /**
     ...
     * @param curses
     */
    public Prayers(final boolean default_prayerbook) {
     ...
     * @param b
     */
    public boolean setEnabled(final int index, final boolean b) {
    ...
    public Integer pollLeech() {
        final Integer leech = leeches.poll();
        if(leech != null)
            leeches.add(leech);
        return leech;
    }
     ...
     */
    public void setPrayerbook(final boolean default_prayerbook) {
        this.default_prayerbook = default_prayerbook;
    }
     ...
     * @return
     */
    public double getBonus(final int skill) {
        for(final BonusPrayer bonusprayer : BONUS_PRAYERS){
    ...
    public void disableFor(final int time, final int... prayers) {
    ...
    public static class DisabledPrayer {
        ...
        private final int[] prayersDisabled;
        private long prayersDisabledAt = -1;
        private long prayersDisabledFor = -1;

        public DisabledPrayer(final long prayersDisabledFor, final int[] prayersDisabled) {
    ...
    public static class BonusPrayer {
         ...
         * @param bonus
         */
        public BonusPrayer(final int id, final int skill, final double bonus) {
            this.id = id;
            this.skill = skill;
            this.bonus = bonus;
        }
