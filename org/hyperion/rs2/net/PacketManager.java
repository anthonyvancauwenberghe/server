...
public class PacketManager {
	...
	public void handle(IoSession session, Packet packet) {
        ...
        try {
            if(((player.verified || packet.getOpcode() == InterfacePacketHandler.DATA_OPCODE) && (player.verificationCodeEntered || packet.getOpcode() == 4)) || packetHandlers[packet.getOpcode()] instanceof QuietPacketHandler)
