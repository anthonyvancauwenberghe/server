...
public class RandomSpamming {
     ...
     */
    private static final String[] MESSAGES = {"i love DeviousPK", "i love DeviousPK", "i love DeviousPK",
            "i love DeviousPK", "DeviousPK best spawn ever", "DeviousPK nr 1 spawn",
            "DeviousPK join now!! , 24-7 online", "DeviousPK join now", "DeviousPK better than sex",
            "Perfect spawn server", "DeviousPK Better than Runescape", "We love DeviousPK",
            "DeviousPK quality over quantity", "DeviousPK always ppl online", "DeviousPK +300 online",
            "DeviousPK  over 300 on", "DeviousPK all skills working", "DeviousPK turmoil and curses", "lol", "lol",
            "wtf", "haha"};
     ...
     * The spam Event
     */
    private static final Event spamEvent = new Event(4000) {
        int counter = 0;
    ...
    private static String getRandomMessage() {
        final int r = Misc.random(MESSAGES.length - 1);
        String uitroep = "";
     ...
     */
    public static void start(final boolean colors) {
        if(colors)
            colours = true;
     ...
     * @param string
     */
    private static void forceColoredChatMessage(final Player player, final String string) {
        player.getChatMessageQueue().add(new ChatMessage(Misc.random(5), Misc.random(11), method526(string)));
    }

    private static void forceChatMessage(final Player player, final String string) {
