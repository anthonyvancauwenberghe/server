...
public class PlayerUpdateTask implements Task {
    ...
    public void appendForceMovement(final PacketBuilder block, final Player otherPlayer) {
        final Location loc = Location.create(otherPlayer.forceWalkX1, otherPlayer.forceWalkY1, 0);
        final Location loc2 = Location.create(otherPlayer.forceWalkX2, otherPlayer.forceWalkY2, 0);
     ...
     * @param otherPlayer The player.
     */
    private void appendPlayerAppearanceUpdate(final PacketBuilder packet, final Player player, final Player otherPlayer) {
