...
public class SkillGuideManager implements ContentTemplate {
    ...
    public static final int[] miniHeadingButtonIds = {8846, 8823, 8824, 8827, 8837, 8840, 8843, 8859, 8862, 8865, 15303,
            15306, 15309,};
    public static final int[] mainHeadingIds = {8846, 8823, 8824, 8827, 8837, 8840, 8843, 8859, 8862, 8865, 15303,
            15306, 15309,};
    ...
    public int[] getValues(final int type) {
        if(type == 0){
            final int[] j = {8846, 8823, 8824, 8827, 8837, 8840, 8843, 8859, 8862, 8865, 15303, 15306, 15309, 8654,
                    8657, 8660, 8663, 8666, 8669, 8672, 8655, 8658, 8661, 8664, 8667, 8670, 12162, 8656, 8659, 8662,
                    8665, 8668, 8671, 13928,};
            return j;
        }
        return null;
    }
    ...
    public void sendInfo(final Player player, final int level, final int itemId, final String string, final int index, final Item[] items, final int[] slots) {
    ...
    public void finishInfoInterface(final Player player, final int index, final Item[] items, final int[] slots) {
        final Item item = new Item(-1, 0);
    ...
    public void openSkillInterface(final Player player, final int skill, int segment, final boolean refresh) {
        ...
        if(segment > mainSkillHeading[skill].length - 1)
            segment = 0;
        int i = 0;
        final Item[] items = new Item[40];
        final int[] addedSlots = new int[40];
        final int switchId = (skill * 10) + segment;
