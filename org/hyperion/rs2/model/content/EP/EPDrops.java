...
public class EPDrops {
    ...
    private static final Item[] PVP_DROPS = {new Item(13887, 1), new Item(13893, 1), new Item(13899, 1),
            new Item(13905, 1), new Item(13884, 1), new Item(13890, 1), new Item(13896, 1), new Item(13902, 1),
            new Item(13870, 1), new Item(13873, 1), new Item(13876, 1), new Item(13858, 1), new Item(13861, 1),
            new Item(13864, 1), new Item(13867, 1),

    };
    private static final Item[] STATUETTES = {new Item(14876, 1), new Item(14878, 1), new Item(14879, 1),
            new Item(14881, 1), new Item(14887, 1), new Item(14880, 1), new Item(14888, 1), new Item(14885, 1),
            new Item(14889, 1),};

    public static Item getEPItem(final int EP) {
        if(EP < 10)
            return null;
        if(EP < 30){
            return LowEPDrop();
    ...
    public int computeWealthRisked(final Player player) {
        return 0;
    }
