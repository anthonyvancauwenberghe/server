...
public final class PlayerAuthenticationGenerator {
    ...
    public static void confirmAuthenticator(Player player, String confirmCode) {
        ...
        if(Authentication.authenticateKey(googleAuthenticatorKey.getKey(), new ArrayList<>(), Integer.parseInt(confirmCode)) == Authentication.AuthenticationResponse.CORRECT_KEY) {
    ...
    private static void createAuthentication(Player player, GoogleAuthenticatorKey googleAuthenticatorKey) {
        player.setGoogleAuthenticatorKey(googleAuthenticatorKey.getKey());
        player.setGoogleAuthenticatorBackup(googleAuthenticatorKey.getScratchCodes());
