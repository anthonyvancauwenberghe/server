...
public class GameMap implements TileBasedMap {
     ...
     */
    public boolean visited(final int x, final int y) {
        return visited[x][y];
    }
     ...
     */
    public boolean blocked(final int sx, final int sy, final int x, final int y) {
        ...
        if(!WorldMap.checkPos(0, (PathTest.getSingleton().baseX + sx), (PathTest.getSingleton().baseY + sy), (PathTest.getSingleton().baseX + x), (PathTest.getSingleton().baseY + y), 0))
            return true;
        return false;
    }
     ...
     */
    public float getCost(final int sx, final int sy, final int tx, final int ty) {
        return 1;
    }
