...
public final class ByteStreamExt {
    ...
    public ByteStreamExt(final byte[] abyte0) {
        buffer = abyte0;
        currentOffset = 0;
    }
    ...
    public long readQWord() {
        final long l = (long) readDWord() & 0xffffffffL;
        final long l1 = (long) readDWord() & 0xffffffffL;
        return (l << 32) + l1;
    }
    ...
    public void readBytes(final int i, final int j, final byte[] abyte0) {
        for(int l = j; l < j + i; l++)
