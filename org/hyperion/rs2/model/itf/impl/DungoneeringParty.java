...
public class DungoneeringParty extends Interface {
    ...
    public void handle(final Player player, final Packet pkt) {
        ...
        switch(id){
            case START:
                final int sizeIndex = pkt.getByte();
                if(sizeIndex < 0)
                    return;
            ...
            case INVITE:
                ...
                p.getActionSender().sendDialogue("Join " + player.getName() + "?", ActionSender.DialogueType.OPTION, 1, Animation.FacialAnimation.DEFAULT, "Yes, I want to join this dungeon", "No");
    ...
    public void respond(final Player player, final int response) {
