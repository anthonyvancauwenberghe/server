...
public class VoteRequest extends SQLRequest {
     ...
     * @param player
     */
    public VoteRequest(final Player player) {
    ...
    public void process(final SQLConnection sql) {
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(rs.getDate("timestamp").toString().equalsIgnoreCase(FORMAT_SQL.format(Calendar.getInstance().getTime()))){
