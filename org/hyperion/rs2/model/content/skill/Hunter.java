...
public class Hunter implements ContentTemplate {
    ...
    public static final int[] IMP_IDS = {1028, 6055, 1029, 6056, 1030, 6057, 1031, 6058, 1032, 6059, 1033, 6060, 1034,
            6061, 1035, 6062, 6063, 7845, 7846, 6064, 7903, 7906};


    public static void addExp(final Player p, final int NpcId) {
        switch(NpcId){
    ...
    public static void addItem(final Player p, final int NpcId) {
        switch(NpcId){
            case 1028:// baby impling
            case 6055:// Baby impling
    ...
    public static int getReq(final int NpcId) {
        switch(NpcId){
            case 1029:// Young impling
            case 6056:// Young impling
                return 22;
    ...
    public void catchImp(final Player p, final int NpcId, final int xcoord, final int ycoord) {
        ...
        if(p.getEquipment().get(Equipment.SLOT_WEAPON) == null || (p.getEquipment().get(Equipment.SLOT_WEAPON).getId() != 11259 && p.getEquipment().get(Equipment.SLOT_WEAPON).getId() != 10010)){
        ...
        switch(NpcId){
            ...
            case 7906:
                ...
                World.getWorld().submit(new Event(500) {
                    public void execute() {
                        final boolean success = HunterNpcs.removeImp(NpcId, xcoord, ycoord);
                        if(success){
                            p.getActionSender().sendMessage("You catch the impling!");
    ...
    @Override
    public boolean clickObject(final Player player, final int type, final int npcId, final int xcoord, final int ycoord, final int d) {
        if(type == 10){
