...
public class Misc {
    ...
    private static final int RestAnimation = 11786;
    private static final int DaxeSpecial = 2876;
    public static int[] HomeTeleportGfx = {775, 800, 801, 802, 803, 804, 1703, 1704, 1705, 1706, 1707, 1708, 1709, 1710,
            1711, 1712, 1713};
    public static int[] HomeTeleportAnimations = {1722, 1723, 1724, 1725, 2798, 2799, 2800, 3195, 4643, 4645, 4646,
            4847, 4848, 4849, 4850, 4851, 4852};

    public static String aOrAn(final String word) {
    ...
    public static String getFormattedValue(final int amount) {
        if(amount >= 1000000){
        ...
        final String priceString = formatter.format(amount);
        return priceString;
    }

    public static boolean isInCircle(final int x, final int y, final int x2, final int y2, final int r) {
     ...
     */
    public static boolean contains(final char needle, final char[] haystack) {
    ...
    public static String centerQuestTab(final String str) {
        String spaces = "";
    ...
    public static String shortNumber(final double amount) {
        if(amount < 1000)
    ...
    public static String wrapString(final String string, final int charWrap) {
        int lastBreak = 0;
     ...
     * {4,6,8}
     */
    public static int[] getColumn(final int[][] bigarray, final int columnindex) {
        final int[] smallarray = new int[bigarray.length];
        int counter = 0;
     ...
     */
    public static int[] mergeArrays(final int[] array1, final int[] array2) {
        final int length1 = array1.length;
        final int length2 = array2.length;
        final int[] newarray = new int[length1 + length2];
        int count = 0;
    ...
    public static String getSkillName(final int level) {
        switch(level){
            case 0:
                return " Attack ";
            case 1:
