...
public class SpiritShields {
     ...
     */
    public static int applyEffects(final CombatEntity defender, final int damg) {
        if(defender == null){
            return 0;
        }
        ...
        if(System.currentTimeMillis() - defender.getPlayer().getExtraData().getLong("ovlreset1") < 15000L)
            return damg;
        final int shieldId = CombatAssistant.getShieldId(defender.getPlayer().getEquipment());
        switch(shieldId){
