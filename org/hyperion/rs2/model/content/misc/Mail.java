...
public class Mail {
    ...
    public static final String[] ALLOWEDHOSTS = {"hotmail", "live", "gmail", "yahoo"};

    public static final char[] ALLOWEDCHARACTERS = {'_', '-', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k',
    ...
    public Mail(final Player owner) {
        player = owner;
    }

    public void setTempmail(final String tempmail) {
    ...
    public void setMail(String mail, final boolean showMsg) {
        ...
        final char[] charArray = mail.toCharArray();
        ...
        for(final String s : ALLOWEDHOSTS){
            if(host.contains(s)){
                this.mail = mail;
