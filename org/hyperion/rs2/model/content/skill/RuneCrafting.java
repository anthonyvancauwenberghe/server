...
public class RuneCrafting implements ContentTemplate {
    ...
    private static final int AIR_ALTAR = 2478, MIND_ALTAR = 2479, WATER_ALTAR = 2480, EARTH_ALTAR = 2481, FIRE_ALTAR = 2482, BODY_ALTAR = 2483, COSMIC_ALTAR = 2484, LAW_ALTAR = 2485, NATURE_ALTAR = 2486, CHAOS_ALTAR = 2487, DEATH_ALTAR = 2488;
    ...
    public int getRuneAmount(final int rune, final int amount, final int level) {
        final Rune r = runes.get(getIndex(rune));
        int prev = 1;
    ...
    public boolean isRunecraftable(final Player client, final int id, final int item, final int slot, final int itemId2) {
        if(getIndex(item) == -1)
            return false;
        ...
        if(ContentEntity.getLevelForXP(client, 20) < r.getLevel()){
            ...
            final int xp = ContentEntity.getLevelForXP(client, 20);
    ...
    public int[] getValues(final int type) {
        if(type == 6){
            final int[] j = {2478, 2479, 2480, 2481, 2482, 2483, 2484, 2485, 2486, 2487, 2488};
            return j;
        }
        if(type == 17){
            final int[] j = {1438, 1448, 1444, 1440, 1442, 1446, 1458, 1462, 1452, 1454, 1456,};
            return j;
        }
    ...
    public boolean clickObject(final Player client, final int type, final int id, final int slot, final int itemId2, final int itemSlot2) {
        if(type == 6){
            if(id == AIR_ALTAR){
                ...
                }else if(isRunecraftable(client, id, 556, slot, itemId2)){
                }
        ...
        if(type == ClickType.DIALOGUE_MANAGER){
            switch(id){
                case 1020:
                    client.getActionSender().sendDialogue("Crafting", ActionSender.DialogueType.OPTION, 1, Animation.FacialAnimation.DEFAULT, "Air", "Water", "Earth", "Fire", "Death");
                    for(int i = 0; i < 5; i++){
