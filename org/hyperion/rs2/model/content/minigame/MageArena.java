...
public class MageArena implements ContentTemplate {
    ...
    public void startMinigame(final Player player) {
        final int height = 0;
    ...
    public void wonMinigame(final Player player) {
    ...
    public int[] getValues(final int type) {
        if(type == 16){
            final int[] j = {905, 907, 908, 909, 910, 911,};
            return j;
        }
        if(type == 6){
            final int[] j = {2878, 2879, 9706, 9707};
            return j;
        }
        return null;
    }
