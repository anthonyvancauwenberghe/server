...
public class ServerCommands implements NewCommandExtension {
    ...
    public List<NewCommand> init() {
        return Arrays.asList(
                ...
                new PointCommand("givekills", Rank.DEVELOPER, PointCommand.Type.KILL),
                new PointCommand("givedeaths", Rank.DEVELOPER, PointCommand.Type.DEATH),
                new PointCommand("giveelo", Rank.DEVELOPER, PointCommand.Type.ELO),
                ...
                new TeleportCommand("kurtpalce", Rank.MODERATOR, Position.create(3441, 9737, 1), false),
                ...
                new PunishCommand("suidyellmute", Rank.DEVELOPER, Target.SPECIAL, org.hyperion.rs2.model.punishment.Type.YELL_MUTE),
                ...
                new PunishCommand("suidmute", Rank.DEVELOPER, Target.SPECIAL, org.hyperion.rs2.model.punishment.Type.MUTE),
                ...
                new PunishCommand("wildyforbid", Rank.DEVELOPER, Target.ACCOUNT, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID),
                new PunishCommand("ipwildyforbid", Rank.DEVELOPER, Target.IP, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID),
                new PunishCommand("macwildyforbid", Rank.DEVELOPER, Target.MAC, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID),
                new PunishCommand("suidwildyforbid", Rank.DEVELOPER, Target.SPECIAL, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID),
                ...
                new UnPunishCommand("unsuidjail", Rank.DEVELOPER, Target.SPECIAL, org.hyperion.rs2.model.punishment.Type.JAIL),
                ...
                new UnPunishCommand("unsuidyellmute", Rank.DEVELOPER, Target.SPECIAL, org.hyperion.rs2.model.punishment.Type.YELL_MUTE),
                ...
                new UnPunishCommand("unsuidmute", Rank.DEVELOPER, Target.SPECIAL, org.hyperion.rs2.model.punishment.Type.MUTE),
                ...
                new UnPunishCommand("unwildyforbid", Rank.DEVELOPER, Target.ACCOUNT, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID),
                new UnPunishCommand("unipwildyforbid", Rank.DEVELOPER, Target.IP, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID),
                new UnPunishCommand("unmacwildyforbid", Rank.DEVELOPER, Target.MAC, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID),
                new UnPunishCommand("unsuidwildyforbid", Rank.DEVELOPER, Target.SPECIAL, org.hyperion.rs2.model.punishment.Type.WILDY_FORBID)
        );
    }
    //</editor-fold>
}
