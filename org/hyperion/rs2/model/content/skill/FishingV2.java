...
public class FishingV2 implements ContentTemplate {
    ...
    public static final int[] FISHING_SPOTS = {316, 320, 319, 323, 325, 327, 326, 332, 330, 309, 310, 311, 314, 315,
            317, 318, 328, 329, 331, 334, 312, 324, 309, 314, 301, 311,};
    private static final int EXPMULTIPLIER = Constants.XPRATE * 2;
    private final Map<Integer, FishingType> firstClick = new HashMap<Integer, FishingType>();
    private final Map<Integer, FishingType> secondClick = new HashMap<Integer, FishingType>();
    ...
    private void fishType(final Player player, final FishingType type, final int x, final int y) {
        ...
        if(ContentEntity.returnSkillLevel(player, 10) < minLevel){
            ContentEntity.sendMessage(player, "You need " + minLevel + " fishing to fish here.");
            return;
        }
    ...
    @Override
    public boolean clickObject(final Player player, final int type, final int npc, final int x, final int y, final int d) {
    ...
    public void init() throws FileNotFoundException {
        ...
        for(final FishingType fishType : FishingType.values()){
    ...
    public enum FishingType {
        SMALL_NET(303, -1, new int[]{316, 320, 319, 323, 325, 327, 326, 332, 330}, new int[]{-1,}, new int[]{317, 321,
                7944,/*fish ids*/}, new int[]{1, 15, 62,/*fish levels*/}, new int[]{10, 40, 120,/*fish xps*/}, 621),
        BAIT_ROD(307, 313, new int[]{-1}, new int[]{316, 320, 319, 323, 325, 327, 326, 332, 330}, new int[]{327, 345,/*fish ids*/}, new int[]{
                5, 10,/*fish levels*/}, new int[]{20, 30,/*fish xps*/}, 622),
        FLY_ROD(309, 314, new int[]{309, 310, 311, 314, 315, 317, 318, 328, 329, 331}, new int[]{-1}, new int[]{335,
                331,/*fish ids*/}, new int[]{20, 30,/*fish levels*/}, new int[]{50, 70,/*fish xps*/}, 622),
        LOBSTER_POT(301, -1, new int[]{324, 312}, new int[]{-1,}, new int[]{377,}, new int[]{40,}, new int[]{90,}, 619),
        BIGNET(305, -1, new int[]{334,}, new int[]{-1,}, new int[]{389, 392,/*fish ids*/}, new int[]{85, 90,/*fish levels*/}, new int[]{
                115, 120,/*fish xps*/}, 620),
        HARPOON(311, -1, new int[]{-1,}, new int[]{313, 322, 312, 324,}, new int[]{359, 371,/*fish ids*/}, new int[]{35,
                50,/*fish levels*/}, new int[]{80, 100,/*fish xps*/}, 618),
        HARPOON_SHARK(311, -1, new int[]{-1,}, new int[]{334,}, new int[]{383,/*fish ids*/}, new int[]{76,/*fish levels*/}, new int[]{
                110,/*fish xps*/}, 618);
        ...
        FishingType(final int itemId, final int bait, final int[] spotIds1, final int[] spotIds2, final int[] fishIds, final int[] fishLevels, final int[] fishXp, final int animationId) {
            this.itemId = itemId;
            this.baitId = bait;
