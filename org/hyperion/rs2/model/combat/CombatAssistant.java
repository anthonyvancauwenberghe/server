...
public class CombatAssistant {
    ...
    public static final int[] TWO_HANDED = {11716, 11717, 13454, 10887, 13905, 13988, 14692, 17143, 14484, 16909, 18369,
            18353, 16425, 4153, 17646, 1307, 1309, 1311, 1313, 1315, 1317, 1319, 6609, 7158,/* 2h weps */4886, 4887,
            4888, 4889, 4982, 4983, 4984, 4985, 4958, 4959, 4960, 4961, 4718, 4710, 4755, 4747, 4734, 4726,/* barrows */
            19605, 11694, 11696, 11698, 11700, 11730,/* godswords */11235,/* darkbow */10113, 9016, 6587, 3095, 3096,
            3097, 3098, 3099, 3100,/* claws */15701, 15702, 15703, 15704, 15241, 16909, 6528
	...
	/* thorwn axes */800, 801, 802, 803, 804, 805, 13883, 13879};
    public static final int[] CBOWS = {9174, 9176, 9177, 9179, 9181, 9183, 9185, 18357, 14121};
    public static final int[][] UNIQUERANGEWEPS = {
            // Wep Id, Wep Ammo
            {15241, 15243}, {4734, 4740}, {14684, 8882}};
    public static final int[] BOWS = {839, 841, 843, 845, 847, 849, 851, 853, 855, 857, 859, 861, 4212, 4214, 4827,
            11235, 15701, 15702, 15703, 15704, 16337, 16887};
    public static final int[][] RANGEDDATA = {{877, 10}, {9140, 46}, {9145, 36}, {9141, 64}, {9142, 82}, {9143, 100},
            {9144, 115}, {9236, 14}, {9237, 30}, {9238, 48}, {9239, 66}, {9240, 83}, {9241, 85}, {9242, 103},
            {9243, 105}, {9244, 117}, {9245, 125}, {882, 7}, {884, 10}, {886, 16}, {888, 22}, {890, 31}, {892, 49},
            {4740, 55}, {11212, 60}, {806, 1}, {807, 3}, {808, 4}, {809, 7}, {810, 10}, {811, 14}, {11230, 20},
            {864, 3}, {863, 4}, {865, 7}, {866, 10}, {867, 14}, {868, 24}, {825, 6}, {826, 10}, {827, 12}, {828, 18},
            {829, 28}, {830, 42}, {800, 5}, {801, 7}, {802, 11}, {803, 16}, {804, 23}, {805, 36}, {9976, 0}, {9977, 15},
            {4212, 70}, {4214, 70}, {4215, 70}, {4216, 70}, {4217, 70}, {4218, 70}, {4219, 70}, {4220, 70}, {4221, 70},
            {4222, 70}, {4223, 70}, {6522, 49}, {10034, 15}, {15015, 130}, {15016, 110}, {4734, 49}, {4740, 49},
            {19157, 80}, {19162, 80}, {19152, 80}, {15243, 140}, {13883, 130}, {13879, 135}, {8882, 145}};
    ...
    public static void addExperience(final CombatEntity combatEntity, final int bowType, final int damage) {
     ...
     * @param combatEntity
     */
    public static void checkSkull(final CombatEntity combatEntity) {
     ...
     * @return
     */
    public static int getShieldId(final Container equipment) {
    ...
    public static final boolean isStab(final Item item) {
        if(item == null)
            return false;
     ...
     * @return
     */
    public static int getArrowsId(final Container equipment) {
     ...
     * @return
     */
    public static int getWeaponId(final Container equipment) {
     ...
     * @return
     */
    public static boolean isValid(final CombatEntity combatEntity) {
     ...
     */
    public static int getCombatStyle(final CombatEntity entity) {
     ...
     * Finds what weapon the client is using.
     */
    public static int getCombatStyle(final Container equipment) {
        /**
         * Get the weapon
         */
        final Item Weapon = equipment.get(Equipment.SLOT_WEAPON);
        /**
         ...
         */
        for(final int g : RANGED_WEAPONS){
            if(g == weaponId)
         ...
         * Declare Arrow
         */
        final Item Arrow = equipment.get(Equipment.SLOT_ARROWS);
        /**
         * Declare arrowId
         */
        int arrowId = -1;
        ...
        for(final Item g : FightPits.rangeItems.get(FightPits.WEAPON)){
            if(g != null){
    ...
    public static boolean isControlled(final int id) {
    ...
    public static boolean exclusivelyNotTwoHanded(final int id) {
        return exclusivelyNot2h.contains(id);
    }

    public static boolean is2H(final int id) {
        final Weapon weapon = Weapon.forId(id);
    ...
    public static int getArrowType(final int arrow) {
        switch(arrow){
            case 882: // Bronze
                return 1;
            case 884: // Iron
    ...
    public static int getUniqueType(final int wep) {
        for(int i = 0; i < UNIQUERANGEWEPS.length; i++){
    ...
    public static int getBoltType(final int arrow, final int weapon) {
    ...
    public static int getDrawback(final int weapon, final int arrow, final int type) {
        switch(weapon){
            case 15241:
                return 2138;
        /*case 13883:
    ...
    public static int getProjectileSpeed(final int weaponId) {
        /*
    ...
    public static int getSlope(final int weaponId) {
        switch(weaponId){
            case 15241:
                return -1;
        }
    ...
    public static int getStartHeight(final int weaponId) {
        switch(weaponId){
            case 15241:
                return 22;
        }
    ...
    public static int getEndHeight(final int weaponId) {
        switch(weaponId){
            case 15241:
                return 22;
        }
    ...
    public static int getDelay(final int weaponId) {
        switch(weaponId){
            case 15241:
                return 30;
        }
    ...
    public static int getArrowGfx(final int weapon, final int bowType, final int type) {
        switch(weapon){
            case 15241:
                return 2143;
            case 13883:
    ...
    public static boolean isVeracEquiped(final Player player) {
        if(player.getEquipment().get(Equipment.SLOT_HELM) == null || player.getEquipment().get(Equipment.SLOT_WEAPON) == null || player.getEquipment().get(Equipment.SLOT_CHEST) == null || player.getEquipment().get(Equipment.SLOT_BOTTOMS) == null)
            return false;
        if(player.getEquipment().get(Equipment.SLOT_HELM).getId() == 4753 && player.getEquipment().get(Equipment.SLOT_WEAPON).getId() == 4755 && player.getEquipment().get(Equipment.SLOT_CHEST).getId() == 4757 && player.getEquipment().get(Equipment.SLOT_BOTTOMS).getId() == 4759)
            return true;
        return false;
    }

    public static int damage(final int maxHit, final Player attacker, final Player victim, final int skill, final boolean prayer, final boolean special, final boolean ignorePrayers) {
        /**
        ...
        double attackBonus = attacker.getBonus().get(attacker.cE.getAtkType()) == 0 ? 1 : attacker.getBonus().get(attacker.cE.getAtkType());
        if(attackBonus < 1){
            attackBonus = 1;
        }
        ...
        final double defenceBonus = victim.getBonus().get(attacker.cE.getAtkType() + 5) == 0 ? 1 : victim.getBonus().get(attacker.cE.getAtkType() + 5);
        ...
        attacker.getActionSender().sendMessage("atk value: " + (hitSucceed * 100));
     ...
     */
    public static double getEffectiveStr(final Player p) {
        return p.getSkills().getLevel(2) * getPrayerStr(p);
    }

    public static double getPrayerStr(final Player p) {
    ...
    public static int getStyleBonus(final Player p) {
        return 1;
        // TODO
    }

    public static int calculateMaxHit(final Player p) {
        double base = 0;

        final double effective = getEffectiveStr(p);
        final double strengthBonus = p.getBonus().get(EquipmentStats.STRENGTH);
        ...
        if(hasDharokEquiped(p)){
            final double ratio = (double) p.getSkills().getLevel(Skills.HITPOINTS) / (double) p.getSkills().getLevelForExp(Skills.HITPOINTS);
            base *= 1.95 - ratio;
        }
        if(base <= 0){
            base = 1;
    ...
    public static boolean obbyZerk(final Player p) {
        if(p.getEquipment().get(Equipment.SLOT_AMULET) == null || p.getEquipment().get(Equipment.SLOT_WEAPON) == null){
            return false;
        }
        if(p.getEquipment().get(Equipment.SLOT_AMULET).getId() == 11128 && p.getEquipment().get(Equipment.SLOT_WEAPON).getId() == 6528)
            return true;
        return false;
    }

    public static boolean fullVoidMelee(final Player player) {
        if(player.getEquipment().get(Equipment.SLOT_HELM) == null || player.getEquipment().get(Equipment.SLOT_GLOVES) == null || player.getEquipment().get(Equipment.SLOT_CHEST) == null || player.getEquipment().get(Equipment.SLOT_BOTTOMS) == null)
            return false;
        if(player.getEquipment().get(Equipment.SLOT_HELM).getId() == 11665 && player.getEquipment().get(Equipment.SLOT_GLOVES).getId() == 8842 && player.getEquipment().get(Equipment.SLOT_CHEST).getId() == 8839 && player.getEquipment().get(Equipment.SLOT_BOTTOMS).getId() == 8840)
            return true;
        return false;
    }

    public static boolean fullVoidRange(final Player player) {
        if(player.getEquipment().get(Equipment.SLOT_HELM) == null || player.getEquipment().get(Equipment.SLOT_GLOVES) == null || player.getEquipment().get(Equipment.SLOT_CHEST) == null || player.getEquipment().get(Equipment.SLOT_BOTTOMS) == null)
            return false;
        if(player.getEquipment().get(Equipment.SLOT_HELM).getId() == 11664 && player.getEquipment().get(Equipment.SLOT_GLOVES).getId() == 8842 && player.getEquipment().get(Equipment.SLOT_CHEST).getId() == 8839 && player.getEquipment().get(Equipment.SLOT_BOTTOMS).getId() == 8840)
            return true;
        return false;
    }
     ...
     * @return
     */
    public static boolean wearingFarseer(final Player player) {
    ...
    public static boolean fullVoidMage(final Player player) {
        if(player.getEquipment().get(Equipment.SLOT_HELM) == null || player.getEquipment().get(Equipment.SLOT_GLOVES) == null || player.getEquipment().get(Equipment.SLOT_CHEST) == null || player.getEquipment().get(Equipment.SLOT_BOTTOMS) == null)
            return false;
        if(player.getEquipment().get(Equipment.SLOT_HELM).getId() == 11663 && player.getEquipment().get(Equipment.SLOT_GLOVES).getId() == 8842 && player.getEquipment().get(Equipment.SLOT_CHEST).getId() == 8839 && player.getEquipment().get(Equipment.SLOT_BOTTOMS).getId() == 8840)
            return true;
        return false;
    }
     ...
     * @return
     */
    public static boolean hasDharokEquiped(final Player player) {
    ...
    public static int getRangedHit2(final Player p) {
        int effectiveStrength = p.getSkills().getLevel(4);
        if(p.cE.bowType == 0)
            effectiveStrength += 3;
        final int max = (int) (1.3 + (effectiveStrength / 10) + (p.getBonus().get(EquipmentStats.ATTACK_RANGED) / 80) + ((p.getBonus().get(EquipmentStats.STRENGTH) * p.getBonus().get(EquipmentStats.ATTACK_RANGED)) / 640));
        return max;
    }

    public static boolean darkBow(final int itemId) {
        switch(itemId){
            case 11235:
            case 15701:
            case 15702:
    ...
    public static int getRangedHit(int maxHit, final int type) {
        /*
    ...
    public static int getRangeStr(final int i) {
        int str = 0;
    ...
    public static int calculateRangeMaxHit(final Player p) {
        final int rangedLevel = p.getSkills().getLevelForExp(4);
        final int rangedBoosted = p.getSkills().getLevel(4);
        int rangedStr = 0;

        if(CombatAssistant.getCombatStyle(p.cE) == Constants.RANGEDWEPSTYPE)
            rangedStr = getRangeStr(p.getEquipment().get(Equipment.SLOT_WEAPON).getId());
        else{
            if(p.getEquipment().get(Equipment.SLOT_ARROWS) != null)
                rangedStr = getRangeStr(p.getEquipment().get(Equipment.SLOT_ARROWS).getId());
        ...
        final double e = Math.floor(rangedLevel * bonus + rangedBoosted / 8);
        ...
        if(p.specOn && p.getEquipment().get(Equipment.SLOT_WEAPON) != null){
            switch(p.getEquipment().get(Equipment.SLOT_WEAPON).getId()){
                ...
                case 15703:
                case 15704:
                    if(p.getEquipment().get(Equipment.SLOT_ARROWS) != null && p.getEquipment().get(Equipment.SLOT_ARROWS).getId() == 11212){
                        specialBonus = 1.3;
                    }else{
                        specialBonus = 1.1;
                    }
    ...
    public static int calculateRangeAttack(final Player p) {
    ...
    public static int calculateRangeDefence(final Entity entity) {
    ...
    public static int calculateMageSplashDef(final Entity entity) {
        if(entity instanceof Player)
    ...
    public static int calculateMageAtk(final Player player) {
    ...
    public static int calculateMageDef(final Entity entity) {
        if(entity == null)
            return 0;
        if(entity instanceof Player){
            final Player player = (Player) entity;
            ...
            final int bonus = player.getBonus().get(EquipmentStats.DEFENCE_MAGIC);
            if(player.getPrayers().isEnabled(0)){
                defLevel *= 1.05;
            }else if(player.getPrayers().isEnabled(5)){
                defLevel *= 1.10;
    ...
    public static int bestMeleeDef(final Player player) {
        if(player.getBonus().get(5) > player.getBonus().get(6) && player.getBonus().get(5) > player.getBonus().get(7))
            return 5;
        if(player.getBonus().get(6) > player.getBonus().get(5) && player.getBonus().get(6) > player.getBonus().get(7))
            return 6;
        return player.getBonus().get(7) <= player.getBonus().get(5) || player.getBonus().get(7) <= player.getBonus().get(6) ? 5 : 7;
    }

    public static int bestMeleeAtk(final Player player) {
        if(player.getBonus().get(0) > player.getBonus().get(1) && player.getBonus().get(0) > player.getBonus().get(2))
            return 0;
        if(player.getBonus().get(1) > player.getBonus().get(0) && player.getBonus().get(1) > player.getBonus().get(2))
            return 1;
        return player.getBonus().get(2) <= player.getBonus().get(0) || player.getBonus().get(2) <= player.getBonus().get(1) ? 0 : 2;
    }

    /**
     * Calculate Melee Atk Value
     */
    public static int calculateMeleeAttack(final Player player) {
     ...
     */
    public static int calculateMeleeDefence(final Entity entity) {
        if(entity instanceof Player){
            final Player player = (Player) entity;
    ...
    public static void drawBackGfx(final CombatEntity combatEntity, final int weaponId, final int arrowId, final int bowType) {
        if(weaponId != 15241)
            combatEntity.doGfx(CombatAssistant.getDrawback(weaponId, arrowId, bowType));
        else
     ...
     */
    public static void fireProjectile(final CombatEntity combatEntity, final int bowType, final int arrowType) {
        if(combatEntity.getOpponent() == null)
            return;
        int weaponId = -1;
        if(combatEntity.getPlayer().getEquipment().get(Equipment.SLOT_WEAPON) != null){
            weaponId = combatEntity.getPlayer().getEquipment().get(Equipment.SLOT_WEAPON).getId();
        }
        final int proj = CombatAssistant.getArrowGfx(weaponId, bowType, arrowType);
        final int offsetY = (combatEntity.getAbsX() - (combatEntity.getOpponent().getAbsX() + combatEntity.getOpponent().getOffsetX())) * -1;
        final int offsetX = (combatEntity.getAbsY() - (combatEntity.getOpponent().getAbsY() + combatEntity.getOpponent().getOffsetY())) * -1;
        // Lockon Target
        final int hitId = combatEntity.getSlotId(combatEntity.getEntity());
        final int speed = CombatAssistant.getProjectileSpeed(weaponId);
        final int slope = CombatAssistant.getSlope(weaponId);
        final int startHeight = CombatAssistant.getStartHeight(weaponId);
        final int endHeight = CombatAssistant.getEndHeight(weaponId);
        final int time = CombatAssistant.getDelay(weaponId);
        // create the projectile
        combatEntity.getPlayer().getActionSender().createGlobalProjectile(combatEntity.getAbsY(), combatEntity.getAbsX(), offsetY, offsetX, 50, speed, proj, startHeight, endHeight, hitId, time, slope);
        if(weaponId != 4212)
            Combat.removeArrow(combatEntity.getPlayer(), bowType, combatEntity.getOpponent().getEntity().getLocation());
    }
