...
public class Smelting implements ContentTemplate {
    ...
    public boolean isSmeltingItem(final int item) {
        for(final SmeltingItem c : smeltingItem){
            if(c == null)
                continue;
            int id = c.getOreId();
            if(id == item)
    ...
    public int getBarIndex(final int item) {
        for(final SmeltingItem c : smeltingItem){
            if(c == null)
                continue;
    ...
    public void openSmelting(final Player c, final int itemId) {
    ...
    public void openSmelting(final Player c) {
    ...
    public int[] getValues(final int type) {
        if(type == 14){
            final int[] j = {436, 438, 440, 442, 444, 447, 449, 451, 453,};
            return j;
        }
        if(type == 7){
            final int[] j = {11666, 2781};
            return j;
        }
        if(type == 0){
            final int[] j = {3987, 3991, 3995, 3999, 4003, 7441, 7446, 7450, 3986, 3990, 3994, 3998, 4002, 7440, 7444,
                    7449, 2807, 3989, 3993, 3997, 4001, 6397, 7443, 7448,};
            return j;
        }
        return null;
    }
