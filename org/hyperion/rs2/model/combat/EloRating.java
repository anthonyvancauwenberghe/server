...
public class EloRating {
     ...
     * @return
     */
    public static int getNewRating(final int rating, final int opponentRating, final int resultType) {
        switch(resultType){
            case WIN:
     ...
     */
    public static int getNewRating(final int rating, final int opponentRating, final double score) {
        ...
        final int maxLoose = -20;
        final int ratingDelta = newRating - rating;
     ...
     */
    private static int calculateNewRating(final int oldRating, final double score, final double expectedScore, final double kFactor) {
