...
public class Trade {
     ...
     * @param player2
     */
    public static void open(final Player player, final Player player2) {
    ...
    public static void withdraw(final Player player, final int slot, final int id, final int amount) {
        if(player.tradeAccept1 && (player.getTrader() == null || player.getTrader().tradeAccept1))
            return;
        final Item item = player.getTrade().get(slot);
        if(item == null){
    ...
    public static void deposit(final Player player, final int slot, final int id, final int amount) {
        final Player trader = player.getTrader();
/*
    ...
    public static void confirmScreen(final Player player) {
        final String sendTrade1 = listConfirmScreen(player.getTrade().toArray());
        final String sendTrade2 = listConfirmScreen(player.getTrader().getTrade().toArray());
    ...
    public static void finishTrade(final Player player) {
	    ...
	    if(player.getTrader().getSkills().getTotalLevel() > 100){
            ...
            player.getLogManager().add(LogEntry.trade(player.getName(), player.getTrader().getName(), player.getTrade().toArray(), player.getTrader().getTrade().toArray()));
            player.getTrader().getLogManager().add(LogEntry.trade(player.getName(), player.getTrader().getName(), player.getTrade().toArray(), player.getTrader().getTrade().toArray()));
    ...
    public static synchronized void declineTrade(final Player player) {
