...
public enum CombatCalculation {
    ...
    public static int getCalculatedDamage(final Entity attacker, final Entity defender, final int randomDamage, final int type, final int maxDamage) {
        try{
    ...
    int magicAttack(final Entity attacker, final Entity defender, final int randomDamage, final int maxDamage) {
        throw new AbstractMethodError("Will not occur");
    }

    int rangeAttack(final Entity attacker, final Entity defender, final int randomDamage, final int maxDamage) {
        throw new AbstractMethodError("Will not occur");
    }

    int meleeAttack(final Entity attacker, final Entity defender, final int randomDamage, final int maxDamage) {
        throw new AbstractMethodError("Will not occur");
    }
