...
public class CombatAssistant {
	...
	public static int calculateRangeAttack(Player p) {
		...
		return (int) (((rangeAtk) + (p.getBonus().get(EquipmentStats.ATTACK_RANGED)/1.6)));
	}
	...
	public static int calculateRangeDefence(Entity entity) {
		if(entity instanceof Player) {
			...
			if(player.getPrayers().isEnabled(0)) {
                ...
                rangeDef *= 1.23;
			return (int)(rangeDef * 0.75) + (int)(player.getBonus().get(EquipmentStats.DEFENCE_RANGED)/1.75) + 74;
		} else //NPCs
	...
	public static int calculateMeleeDefence(Entity entity) {
		if(entity instanceof Player) {
			...
			return (int) (meleeDef * .7 + bonus * .7) + 70;
		} else {
