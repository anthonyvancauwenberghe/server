...
public class CharDesignPacketHandler implements PacketHandler {
    ...
    private static final Boundary[] MALE_VALUES = {new Boundary(0, 8), // head
    ...
    private static final Boundary[] FEMALE_VALUES = {new Boundary(45, 54), // head
    ...
    private static final Boundary[] ALLOWED_COLORS = {new Boundary(0, 11), // hair color
    ...
    public void handle(final Player player, final Packet packet) {
        ...
        for(int i = 0; i < ALLOWED_COLORS.length; i++){
            final int value = packet.getByte();
