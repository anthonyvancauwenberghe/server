...
public class ServerCommands implements NewCommandExtension {
    ...
    public List<NewCommand> init() {
        return Arrays.asList(
                ...
                new TeleportCommand("sdpvm", Rank.SUPER_DONATOR, Time.FIFTEEN_SECONDS, Position.create(3506, 9494, 4), false),
                ...
                new TeleportCommand("ardypvp", Rank.PLAYER, Time.FIFTEEN_SECONDS, Position.create(2663, 3307, 0), false),
