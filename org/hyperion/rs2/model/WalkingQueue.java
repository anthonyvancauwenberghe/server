...
public class WalkingQueue {
    ...
    private final int lastCombatLevel = -1;
    /**
     * The queue of waypoints.
     */
    private final Point[] walkingQueue = new Point[50];
    private final boolean inArdyPvp = true;
    /**
     * The entity.
     */
    ...
    protected static boolean hasSnowball(final Player player) {
    ...
    public void addStep(final int x, final int y) {
        ...
        if(entity instanceof NPC){
            final Location target = Location.create(x, y, 0);
    ...
    private void addStepInternal(final int x, final int y) {
        ...
        final int diffX = x - lastX;
        final int diffY = y - lastY;
    ...
    public boolean walkingCheck() {
        ...
        if(entity instanceof Player){
            ...
            final int wildLevel = Combat.getWildLevel(player.getLocation().getX(), player.getLocation().getY(), player.getLocation().getZ());
