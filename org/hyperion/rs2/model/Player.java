...
public class Player extends Entity implements Persistable, Cloneable {
    ...
    private final LinkedList<SavedSingleValue> savedValues = new LinkedList<SavedSingleValue>();
    private final Agility agility = new Agility(this);
    private final PlayerChecker playerChecker = PlayerChecker.create();
    private final HashMap<AchievementData, Integer> achievementsProgress = new HashMap<>();
    private final AccountValue accountValue = new AccountValue(this);
    private final AccountLogger logger = new AccountLogger(this);
    private final PlayerPoints playerPoints = new PlayerPoints(this);
    private final ExpectedValues expectedValues = new ExpectedValues(this);
    private final Spam spam = new Spam(this);
    private final SpecialBar specbar = new SpecialBar(this);
    private final SummoningBar summoningBar = new SummoningBar(this);
    private final Yelling yelling = new Yelling();
    private final ExtraData extraData = new ExtraData();
    private final QuestTab questtab = new QuestTab(this);
    private final PollInterface poll = new PollInterface(this);
    private final SpawnTab spawntab = new SpawnTab(this);
    private final AchievementTab achievementtab = new AchievementTab(this);
    private final News news = new News(this);
    private final ItemDropping itemDropping = new ItemDropping();
    private final TriviaSettings ts = new TriviaSettings(0, false);
    private final Mail mail = new Mail(this);
    private final SkillingData sd = new SkillingData();
    /**
     * The password.
     */
    ...
    private final AtomicInteger overloadCounter = new AtomicInteger(0);
    /**
     * PvP Armour storage, initialized in saving
     */

    private final PvPArmourStorage pvpStorage = new PvPArmourStorage();
    //private int[] bonus = new int[12];
    private final EquipmentStats bonus = new EquipmentStats();
    private final Prayers prayers = new Prayers(true);
    /**
     * The player's appearance information.
     */
    private final Appearance appearance = new Appearance();
    private final SpellBook spellBook = new SpellBook(SpellBook.DEFAULT_SPELLBOOK);
    private final Farm farm = Farming.getFarming().new Farm();
    private final AutoSaving autoSaving = new AutoSaving(this);
    private final int playerUptime = 0;
    private final String[] lastKills = {"", "", "", "", ""};
    private final BankField bankField = new BankField(this);
    public int pin = -1;
    ...
    */
     ...
     */
    public Player(final PlayerDetails details, final boolean newCharacter) {
        super();
    ...
    public static int getConfigId(final int i) {
        switch(i){
            case 0:
                return 0;
    ...
    public void setDoubleChar(final boolean b) {
    ...
    public void setNeedsNameChange(final boolean b) {
        needsNamechange = b;
    }
    ...
    public BarrowsFFAHolder getBarrowsFFA() {
        return barrowsFFA;
    }
    ...
    public void setTutorialProgress(final int step) {
    ...
    public void setBanking(final boolean status) {
        isBanking = status;
    }
    ...
    public void setMaxCape(final boolean b) {
        hasMaxCape = b;
    }
    ...
    public void setCompCape(final boolean b) {
        hasCompCape = b;
    }
    ...
    public void setViewingDifficulty(final Difficulty viewingDifficulty) {
    ...
    private void checkContainers(final int id, final boolean add, final String name) {
    ...
    public void setLastHonorPointsReward(final long time) {
    ...
    public void setPreviousSessionTime(final long time) {
    ...
    public void setCanSpawnSet(final boolean b) {
        this.canSpawnSet = b;
    }
    ...
    public void init() {
        ...
        try{
            final File f = new File("./data/charfarm/" + getName() + ".bin");
    ...
    public void serialize() {
        try{
            final OutputStream os = new FileOutputStream("data/charfarm/" + this.getName() + ".bin");
            final IoBuffer buf = IoBuffer.allocate(1024);
            buf.setAutoExpand(true);
    ...
    public void setHasTarget(final boolean b) {
        hasTarget = b;
    }
    ...
    public void setCreatedTime(final long created) {
    ...
    public int getRisk() {
        int totalvalue = 0;
        final List<Item> list = new ArrayList<Item>(Equipment.SIZE + Inventory.SIZE);
        Collections.addAll(list, getInventory().toArray());
        Collections.addAll(list, getEquipment().toArray());
    ...
    public void setDiced(final int diced) {
        this.diced = diced;
    }
    ...
    public void setSkullTimer(final int timer) {
        skullTimer = timer;
    }
    ...
    public void setLastVoted(final long time) {
        lastVoted = time;
    }
    ...
    public void increaseEP() {
        if(EP == 100 || getLocation().getZ() != 0)
            return;
        final int addEP = Misc.random(15) + 15;
        if(EP + addEP > 100)
            EP = 100;
        else
            EP += addEP;
    ...
    public void setModeration(final Player p) {
        this.onModeration = p;
    }
    ...
    public void setSkilling(final boolean b) {
        isSkilling = b;
    }
    ...
    public void setCanWalk(final boolean b) {
        canWalk = b;
    }
    ...
    public void setPNpc(final int id) {
        this.npcId = id;
    ...
    public double setDrainRate(final double i) {
        return drainRate = i;
    }
    ...
    public void setShopId(final int a) {
        shopId = a;
    }
    ...
    public void setTradeWith(final Player p) {
        tradeWith = p;
    }
    ...
    public void setBob(final int size) {
    ...
    public void setPlayerRank(final long playerRank) {
    ...
    public String toString() {
        return Player.class.getName() + " [name=" + name + " playerRank=" + playerRank + " members=" + members + " index=" + this.getIndex() + "]";
    }
    ...
    public void heal(final int hp, final int skill) {
        final int cHp = skills.getLevel(skill);
        if(skill == 3){
    ...
    public void heal(final int hp, final boolean brew) {
        final int cHp = skills.getLevel(3);
        final int j = 3;
        final int brewBonus = (int) (skills.calculateMaxLifePoints() * .15);
        if(j == 3){
    ...
    public int getInflictDamage(int damg, final Entity source, final boolean poison, final int style) {
        final HitType hitType = HitType.NORMAL_DAMAGE;
    ...
    public int inflictDamage(int damg, final Entity source, final boolean poison, final int style) {
        ...
        final boolean npc = source instanceof NPC;
        getInterfaceState().resetInterfaces();
        /*if(npc) {
			NPC n = (NPC)source;
	...
	*/
        ...
        final Hit hit = new Hit(damg, hitType, style);
    ...
    @Override
    public void deserialize(final IoBuffer buf, final boolean accCheckerMode) {// load
        System.out.println("Calling deserializable");
    }

    public void emoteTabPlay(final Animation anim) {
        if(isDoingEmote){
    ...
    @Override
    public void serialize(final IoBuffer buf) {// save method
    ...
    public void decreaseEnergy(final int am) {
    ...
    public void increasePitsDamage(final int fightPitsDamage) {
    ...
    public void setPitsDamage(final int fightPitsDamage) {
        this.fightPitsDamage = fightPitsDamage;
    }

    public void increaseCorpDamage(final int i) {
        damagedCorp += i;
    }
    ...
    public void setCorpDamage(final int i) {
        damagedCorp = i;
    }
    ...
    public void setTeleBlock(final long l) {
        // TODO Auto-generated method stub
        teleBlockTimer = l;
    }
    ...
    public void setPvPTask(final PvPTask task) {
        currentPvPTask = task;
    }
    ...
    public void setPvPTaskAmount(final int am) {
        pvpTaskAmount = am;
    }

    public void decrementPvPTask(final int delta) {
    ...
    public void setClanRank(final int r) {
        clanRank = r;
    }
    ...
    public boolean isClanMainOwner() {
        if(clanName == null || clanName.isEmpty())
            return false;
        final Clan clan = ClanManager.clans.get(clanName);
    ...
    public String getClanRankName() {
        ...
        switch(clanRank){
            ...
            case 1:
                rank = "Recruit";
                if(Dicing.diceClans.contains(clanName))
                    rank = "100K max";
                break;
            case 2:
                rank = "Corporal";
    ...
    public void increaseKillStreak() {
        ...
        switch(killStreak){
            case 5:
                for(final Player p : World.getWorld().getPlayers())
                    if(p != null)
                        p.sendPkMessage(getSafeDisplayName() + " is on a " + killStreak + " killstreak!");
                break;
            case 7:
                for(final Player p : World.getWorld().getPlayers())
                    if(p != null)
                        p.sendPkMessage(getSafeDisplayName() + " has begun a rampage with a killstreak of " + killStreak);
                break;
            case 9:
                for(final Player p : World.getWorld().getPlayers())
                    if(p != null)
                        p.sendPkMessage(getSafeDisplayName() + " is on a massacre with " + killStreak + " kills!");
                break;
        }
        if(killStreak >= 10){
            if(Math.random() > 0.5){
                for(final Player p : World.getWorld().getPlayers()){
                    if(p != null){
                        p.sendPkMessage(getSafeDisplayName() + " now has " + killStreak + " kills in a row! Kill him and gain " + bounty + " Pk points!");
                    }
                }
            }else{
                final String ppl = getPeopleString();
                for(final Player p : World.getWorld().getPlayers()){
                    if(p != null){
                        p.sendPkMessage(getSafeDisplayName() + " has killed " + killStreak + ppl + " in a row! Kill him and gain " + bounty + " Pk points!");
                    }
                }
            }
        }
    ...
    public void addLastKill(final String name) {
    ...
    public boolean killedRecently(final String name) {
        for(final String s : lastKills){
            if(s.equals(name))
                return true;
        }
        return false;
    ...
    public ActionSender sendMessage(final Object... message) {
        return sendHeadedMessage(null, null, message);
    }

    public ActionSender sendPkMessage(final Object... message) {
        if(!getPermExtraData().getBoolean("disabledPkMessages"))
            return sendHeadedMessage("@dbl@", "[APk]", message);
        return getActionSender();
    }

    public ActionSender sendLootMessage(final String tag, final Object... message) {
        if(!getPermExtraData().getBoolean("disabledLootMessages"))
            return sendHeadedMessage("@gre@", "[" + tag + "]", message);
        return getActionSender();
    }

    public ActionSender sendServerMessage(final Object... message) {
        return sendHeadedMessage("@whi@", "[Server]", message);
    }

    public ActionSender sendStaffMessage(final Object... message) {
        return sendHeadedMessage("@blu@", "[Staff]", message);
    }

    public ActionSender sendClanMessage(final Object... message) {
        return sendHeadedMessage("@dre@", null, message);
    }

    public ActionSender sendImportantMessage(final Object... message) {
        return sendHeadedMessage("@dre@", "[Important]", message);
    }

    public ActionSender sendf(final String message, final Object... args) {
        try{
    ...
    public void setKillCount(final int kc) {
        killCount = kc;
    }
    ...
    public void setOverloaded(final boolean b) {
        isOverloaded = b;
    }
    ...
    public void addCharge(final int seconds) {
        if(chargeTill < System.currentTimeMillis())
            chargeTill = System.currentTimeMillis();
        final Date date = new Date(chargeTill);
    ...
    public void setTurkeyKills(final int turkeyKills) {
    ...
    public int setTreasureScroll(final int treasureScroll) {
    ...
    public void setStartValue(final int value) {
