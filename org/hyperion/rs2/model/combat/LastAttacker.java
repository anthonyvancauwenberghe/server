...
public class LastAttacker {
    ...
    public LastAttacker(final String clientName) {
        latest = "";
        this.clientName = clientName;
        lastAttack = System.currentTimeMillis() - 9000;
    }

    public void updateLastAttacker(final String name) {
        updateLastAttacker(name, true);
    }

    public void updateLastAttacker(final String name, final boolean first) {
    ...
    public void updateLastAttacker(final int npcIndex) {
