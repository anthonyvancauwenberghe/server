 ...
 */
public class OverloadStatsEvent extends Event {
    /**
     ...
     * @param player
     */
    public OverloadStatsEvent(final Player player) {
        super(DELAY);
        this.player = player;
    ...
    public static class OverloadFactory {
         ...
         */
        public static void endOverload(final Player player) {
        ...
        public static int getBoost(final Player player, final int skillId) {
            ...
            final int boostedLevel = (int) (boostPercentage * player.getSkills().getLevelForExp(skillId)) + bonus;
            final int currentLevelDiff = player.getSkills().getLevel(skillId) - player.getSkills().getRealLevels()[skillId];
         ...
         * Appends boosts
         */
        public static void applyBoosts(final Player player) {
