...
public class Woodcutting implements ContentTemplate {
     ...
     */
    private static final int[] NORMAL_TREES = {1276, 1277, 1278, 1279, 1280, 1282, 1283, 1284, 1285, 1286, 1289, 1290,
            1291, 1315, 1316, 1318, 1319, 1330, 1331, 1332, 1365, 1383, 1384, 2409, 3033, 3034, 3035, 3036, 3881, 3882,
            3883, 5902, 5903, 5904};
    ...
    private static boolean cutVine(final Player client, final int object, final int x, final int y) {
        ...
        if(axe == -1){
            client.getActionSender().sendMessage("You do not have an axe that you can use.");
            return true;
        }
        if(ContentEntity.returnSkillLevel(client, Skills.WOODCUTTING) < 27){
            client.getActionSender().sendMessage("You need 27 woodcutting to cut vines.");
            return true;
        }
     ...
     * @return
     */
    public static final boolean cut(final Player client, final int object, final int x, final int y) {
        if(!isTree(object))
            return false;
            ...
            public void execute() {
                ...
                if(fNumberOfCycles == 1 || Math.random() > WOODCUTTING_FACTOR){
                    ...
                    if(contains(NORMAL_TREES, object)){
                        ...
                        client.getActionSender().sendMessage("You get some logs.");
                        ...
                        client.getActionSender().sendMessage("You get some willow logs.");
                        ...
                        client.getActionSender().sendMessage("You get some oak logs.");
                        ...
                        client.getActionSender().sendMessage("You get some magic logs.");
                        ...
                        client.getActionSender().sendMessage("You get some maple logs.");
                        ...
                        client.getActionSender().sendMessage("You get some mahogany logs.");
                        ...
                        client.getActionSender().sendMessage("You get some tweak logs.");
                        ...
                        client.getActionSender().sendMessage("You get some achey logs.");
                        ...
                        client.getActionSender().sendMessage("You get some yew logs.");
                    }
                    // add xp
                    ContentEntity.addSkillXP(client, xp * EXPMULTIPLIER, 8);
                }
    ...
    public static int getTreeLevel(final int id) {
        int level = 1;
     ...
     * @return
     */
    private static final int hasAxe(final Player client) {
        int ct = 0;
        final int level = client.getSkills().getLevel(8);
        for(final int id : AXES){
     ...
     * @return
     */
    public static boolean isTree(final int id) {
        return contains(NORMAL_TREES, id) || contains(OAK_TREES, id) || contains(WILLOW_TREES, id) || contains(MAGIC_TREES, id) || contains(MAPLE_TREES, id) || contains(MAHOGANY_TREES, id) || contains(TEAK_TREES, id) || contains(ACHEY_TREES, id) || contains(YEW_TREES, id);
    }
    ...
    public int[] getValues(final int type) {
        if(type == 6){
            final int[] j = {/*vines*/5103, 5104, 5105, 5106, 5107,/*trees*/1276, 1277, 1278, 1279, 1280, 1282, 1283,
                    1284, 1285, 1286, 1289, 1290, 1291, 1315, 1316, 1318, 1319, 1330, 1331, 1332, 1365, 1383, 1384,
                    2409, 3033, 3034, 3035, 3036, 3881, 3882, 3883, 5902, 5903, 5904, 1308, 5551, 5552, 5553, 1281,
                    3037, 1292, 1306, 1307, 4677, 9034, 9036, 2023, 1309,};
            return j;
        }
        return null;
    }
