...
public class EquipmentReq {
    ...
    public static int requiredEloRating(final int id) {
        switch(id){
            case 19817:
            case 19816:
            case 19815:
    ...
    public static int requiredHonorPoints(final int id) {
        switch(id){
            case 19817:
            case 19816:
            case 19815:
    ...
    public static boolean canEquipItem(final Player player, final int id) {
        ...
        final int requiredElo = requiredEloRating(id);
    ...
    public static byte[] getRequirements(String s, final int ItemId) {

        final byte[] equipReqData = new byte[Skills.SKILL_COUNT];
        int type = 3;
        if(Equipment.equipmentTypes.get(ItemId) != null)
            type = Equipment.equipmentTypes.get(ItemId).getSlot();
        final boolean isWep = type == 3;
        ...
        final int skillCape = SkillcapeAnim.skillIdForCape(ItemId);
