...
public class Appearance {
     ...
     */
    public int[] getLook() {
        return new int[]{gender, hairColour, torsoColour, legColour, feetColour, skinColour, head, chest, arms, hands,
                legs, feet, beard, standAnim, walkAnim, runAnim};
    }
     ...
     * @param look
     */
    public void setLook2(final int[] look) {
        if(look.length != 13){
            throw new IllegalArgumentException("Array length must be 13.");
        }
        gender = look[0];
    ...
    public void setAnimations(final int a, final int b, final int c) {
        standAnim = a;
        walkAnim = b;
        runAnim = c;
    }
    ...
    public void setWalkAnim(final int i) {
        walkAnim = i;
    }
