...
public class Time {
     ...
     */
    public static final long ONE_SECOND = 1000L, FIVE_SECONDS = 5 * ONE_SECOND, TEN_SECONDS = 10 * ONE_SECOND, FIFTEEN_SECONDS = 15 * ONE_SECOND, THIRTY_SECONDS = 30 * ONE_SECOND,

    ONE_MINUTE = 1000 * 60L, FIVE_MINUTES = 5 * ONE_MINUTE, TEN_MINUTES = 10 * ONE_MINUTE, THIRTY_MINUTES = 30 * ONE_MINUTE,

    ONE_HOUR = ONE_MINUTE * 60, TEN_HOURS = ONE_HOUR * 10, FIVE_TEEN_HOURS = ONE_HOUR * 15, ONE_DAY = ONE_HOUR * 24, TWO_DAYS = ONE_DAY * 2, ONE_WEEK = ONE_DAY * 7, ONE_MONTH = (long) (ONE_DAY * 30.42);
