...
public class AStarPathFinder implements PathFinder {
     ...
     */
    public Path findPath(final int sx, final int sy, final int tx, final int ty) {
            ...
            for(int x = -1; x < 2; x++){
                for(int y = -1; y < 2; y++){
                    ...
                    if(isValidLocation(current.x, current.y, xp, yp)){
                        ...
                        final float nextStepCost = current.cost + getMovementCost(current.x, current.y, xp, yp);
     ...
     */
    protected boolean isValidLocation(final int sx, final int sy, final int x, final int y) {
     ...
     */
    public float getMovementCost(final int sx, final int sy, final int tx, final int ty) {
     ...
     */
    public float getHeuristicCost(final int x, final int y, final int tx, final int ty) {
