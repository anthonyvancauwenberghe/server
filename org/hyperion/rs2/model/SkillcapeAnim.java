...
public class SkillcapeAnim {
    ...
    public static int skillIdForCape(final int cape) {
        switch(cape){
            case 9747:
            case 9748:
                return 0;
    ...
    public static void skillcapeEmote(final Player player) {
        ...
        if(cape != -1){
            final int skillId = skillIdForCape(cape);
            switch(skillId){
            /*
		     * Attack cape.
		     */
            ...
            if(skill == -1 || player.getSkills().getLevelForExp(skill) >= 99){
                ...
                player.getActionSender().sendMessage("You need to be level 99 " + skillcapeName + " to do the " + skillcapeName + " emote.");
            }
        }else{
            player.getActionSender().sendMessage("You need to be wearing a skillcape to do the skillcape emote.");
        }
