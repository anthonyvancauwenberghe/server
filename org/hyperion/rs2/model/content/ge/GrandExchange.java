...
public class GrandExchange {
     ...
     */
    private final Offer[] offers = new Offer[6];
    ...
    public void openOffers() {
        for(int index = 0; index < offers.length; index++){
            ...
            if(offer != null){
                ...
                final int offerComponent = 23714 + (9 * index);
     ...
     * @param slot
     */
    public void openOffer(final int slot) {
        if(offers[slot] != null){
            final Offer offer = offers[slot];
            openOfferIndex = slot;
            final ItemDefinition def = ItemDefinition.forId(offer.getItemId());
     ...
     * @param buy
     */
    public void newOffer(final boolean buy, final int slot) {
        openOfferIndex = slot;
    ...
    public void refreshNewOffer() {
        final boolean buy = newOffer.getType() == 0;
        player.getActionSender().sendString((buy ? "Buy" : "Sell") + " Offer", 22662);
        player.getActionSender().sendHideComponent(22684, !buy);
        player.getActionSender().sendHideComponent(22685, buy);
        player.getActionSender().sendHideComponent(22725, !buy);
        if(newOffer.getCollection() != null){
            final ItemDefinition def = ItemDefinition.forId(newOffer.getItemId());
    ...
    public void setNewOffer(final Offer offer) {
        this.newOffer = offer;
    }
