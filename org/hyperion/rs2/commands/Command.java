...
public abstract class Command {
     ...
     * @param ranks
     */
    public Command(final String key, final Rank... ranks) {
    ...
    private boolean shouldRecord(final Rank[] rights) {
        if(Server.NAME.equalsIgnoreCase("arterobeta"))
            return false;
        for(final Rank right : rights){
     ...
     */
    public String filterInput(final String input) {
    ...
    public int[] getIntArray(String input) {
        ...
        final int[] intArray = new int[parts.length];
