...
public class CommandHandler {
	...
	static {
        ...
        CommandHandler.submit(new UnPunishCommand("unmacyellmute", Target.MAC, Type.YELL_MUTE, Rank.COMMUNITY_MANAGER));
        ...
        CommandHandler.submit(new UnPunishCommand("unmacmute", Target.MAC, Type.MUTE, Rank.COMMUNITY_MANAGER));
        ...
        CommandHandler.submit(new UnPunishCommand("unmacban", Target.MAC, Type.BAN, Rank.COMMUNITY_MANAGER));
