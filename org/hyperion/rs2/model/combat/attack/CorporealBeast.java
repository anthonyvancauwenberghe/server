...
public class CorporealBeast implements Attack {
     ...
     */
    public static int reduceDamage(final Player atk, int damage, final int style) {
        final Item weapon = atk.getEquipment().get(Equipment.SLOT_WEAPON);
     ...
     */
    public static void stomp(final NPC n, final CombatEntity attack, final boolean sendHome) {
        if(n == null)
            return;
            ...
            if(attackId == 0){
                ...
                World.getWorld().submit(new Event(1500) {
                    ...
                    public void execute() {
                        ...
                        for(final Player players : World.getWorld().getRegionManager().getLocalPlayers(n)){
                            ...
                            slope = 3 + distance;
                            final CombatEntity atk = players.getCombat();
