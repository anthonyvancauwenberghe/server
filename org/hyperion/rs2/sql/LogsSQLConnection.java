...
public class LogsSQLConnection extends MySQLConnection {
    ...
    public LogsSQLConnection(final Configuration config) {
        super("LogsSQL", config.getString("logsurl"), config.getString("logsuser"), config.getString("logspass"), 30000, 10000, 100);
    }


    public LogsSQLConnection(final String url, final String username, final String password) {
        super("LogsSQL", url, username, password, 30000, 10000, 100);
    }
