...
public class NewGameMode implements ContentTemplate {
    ...
    private static final int[][] MAIN_STARTER = new int[][]{ //{id, amt},
            {562, 10000}, {563, 10000}, {561, 10000}, {554, 10000}, {557, 10000}, {555, 10000}, {560, 10000},
            {9075, 10000}, {565, 10000}, {391, 10000}, {10828, 100}, {11283, 100}, {11732, 100}, {7462, 100},
            {2414, 100}, {10499, 100}, {6731, 100}, {6733, 100}, {6735, 100}, {6737, 100}, {4151, 100}, {4587, 100},
            {1305, 100}, {1434, 100}, {1215, 100}, {4153, 100}, {11716, 100}, {6585, 100}, {1725, 100}, {1712, 100},
            {4716, 100}, {4753, 100}, {4745, 100}, {4724, 100}, {4708, 100}, {4732, 100}, {6128, 100}, {9185, 100},
            {2581, 100}, {4675, 100}, {4720, 100}, {4757, 100}, {4749, 100}, {4728, 100}, {4712, 100}, {4736, 100},
            {6129, 100}, {9245, 10000}, {2503, 100}, {6889, 100}, {4722, 100}, {4759, 100}, {4751, 100}, {4730, 100},
            {4714, 100}, {4738, 100}, {6130, 100}, {11235, 100}, {2497, 100}, {6914, 100}, {4718, 100}, {4755, 100},
            {4747, 100}, {4726, 100}, {4710, 100}, {4734, 100}, {4131, 100}, {11212, 10000}, {2577, 100}, {6920, 100},
            {2436, 500}, {2440, 500}, {2442, 500}, {2434, 500}, {2444, 500}, {3040, 500}, {2446, 500}, {6685, 500},
            {3024, 500}, {15332, 5}, {145, 500}, {157, 500}, {163, 500}, {139, 500}, {169, 500}, {3042, 500},
            {175, 500}, {6687, 500}, {3026, 500}, {15333, 5}, {147, 500}, {159, 500}, {165, 500}, {141, 500},
            {171, 500}, {3044, 500}, {177, 500}, {6689, 500}, {3028, 500}, {15334, 5}, {149, 500}, {161, 500},
            {167, 500}, {143, 500}, {173, 500}, {3046, 500}, {179, 500}, {6691, 500}, {3030, 500}, {15335, 5},};
    private static final int IRON_STARTER[][] = {{15332, 2}, {6685, 100}, {3024, 75}, {2436, 50}, {2440, 50},
            {2444, 50}, {3040, 50}, //pots
    ...
    static {
        CommandHandler.submit(new Command("getprice", Rank.PLAYER) {
            ...
            public boolean execute(final Player p, final String command) {
                final int[] id = getIntArray(command);
        ...
        CommandHandler.submit(new Command("sellitem", Rank.PLAYER) {
            ...
            public boolean execute(final Player player, final String input) {
                ...
                final int amount = parts.length == 2 ? parts[1] : 1;
                if(amount > 1000 || amount < 1){
                    player.sendMessage("Amount is too small or too large");
                    return false;
                }

                final int price = (int) (getUnitPrice(id) * SELL_REDUCTION);
                final int amountsold = player.getInventory().remove(Item.create(id, amount));
                final long $money = price * amountsold;
        ...
        CommandHandler.submit(new Command("setitemprice", Rank.ADMINISTRATOR) {
            ...
            public boolean execute(final Player player, final String input) {
                ...
                try{
                    final int[] array = getIntArray(input);
                    final int id = array[0];
                    final int price = array[1];
                    prices.put(id, price);
    ...
    public static long getUnitPrice(final int id, final int amount) {
        final int donorprice = DonatorShop.getPrice(id);
        if(donorprice > 100)
    ...
    public boolean dialogueAction(final Player player, final int dialogueId) {
        switch(dialogueId){
            case 10000:
                player.getActionSender().sendDialogue("Select an option", ActionSender.DialogueType.OPTION, 1, Animation.FacialAnimation.DEFAULT, "@blu@Begin tutorial:@bla@ You will receive a '@dre@Fire Cape@bla@' upon completion.", "@blu@Skip tutorial:@bla@ You will not receive the tutorial reward.");
            ...
            case 10003:
                ...
                player.getActionSender().sendDialogue("Select an option", ActionSender.DialogueType.OPTION, 1, Animation.FacialAnimation.DEFAULT, "Normal mode (recommended)", "Hard mode");
