...
public class Scoreboard implements ContentTemplate {
    ...
    public static LinkedList<ScoreboardPlayer> getTopList() {
        ...
        final LinkedList<ScoreboardPlayer> fullList = new LinkedList<ScoreboardPlayer>();
    ...
    public static void sendScoreboard(final Player player) {
        ...
        int i = 0;
        for(final ScoreboardPlayer sp : getTopList()){
    ...
    public static LinkedList<ScoreboardPlayer> top(final LinkedList<ScoreboardPlayer> fullList, final int top) {
        if(top > fullList.size())
            return fullList;
        final LinkedList<ScoreboardPlayer> toplist = new LinkedList<ScoreboardPlayer>();
        //Create toplist by storing the best in it, a variation of selection sort.
        for(int i = 0; i < top; i++){
            ScoreboardPlayer best = fullList.get(0);
            for(final ScoreboardPlayer sp : fullList){
