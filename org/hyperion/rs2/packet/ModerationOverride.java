...
public class ModerationOverride {
    ...
    public static final void kickPlayer(final Player p) {
        p.getSession().close();
    }

    public static final void jailPlayer(final Player p) {
        p.setTeleportTarget(Jail.LOCATION);
    }

    public static final void mutePlayer(final Player p) {
        p.isMuted = true;
