...
public class BankPin {
     ...
     */
    public static void loadUpPinInterface(final Player player) {
        loadUpPinInterface(player, true);
    }

    public static void loadUpPinInterface(final Player player, final boolean bank) {
    ...
    public static void clickPinButton(final Player player, final int button) {
        int index = -1;
        for(int i = 0; i < 10; i++){
    ...
    public static void setStars(final Player player) {
        for(int i = 0; i < 4; i++){
    ...
    public static void randomizeButtons(final Player player) {
        int i = 0;
        for(i = 0; i < 10; i++){
            player.pinOrder[i] = 0;
        }
