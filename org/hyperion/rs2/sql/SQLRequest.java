...
public abstract class SQLRequest implements Comparable<SQLRequest> {
     ...
     * in a different way.
     */
    public static final int DONATION_REQUEST = 0, VOTE_REQUEST = 1, MAIL_REQUEST = 2, QUERY_REQUEST = 3, TRADE_REQUEST = 4, LOW_PRIORITY_REQUEST = 10;
    /**
     * The type of request.
     */
     ...
     */
    public SQLRequest(final int type) {
        this.type = type;
    }
     ...
     */
    @Override
    public int compareTo(final SQLRequest request) {
