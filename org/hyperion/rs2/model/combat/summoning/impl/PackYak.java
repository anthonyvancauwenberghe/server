...
public final class PackYak extends AbstractSummoningSpecial {
    ...
    public PackYak(final int usedWith, final int slot) {
    ...
    @Override
    public boolean checkRequirements(final Player p) {
        return true;
    }
    ...
    public void execute(final Player player) {
        ...
        final BankItem bankItem = new BankItem(0, item.getId(), item.getCount());
    ...
    @Override
    public void executeOpponent(final Entity p) throws NullPointerException {
        // TODO Auto-generated method stub

    }

    @Override
    public void executeFamiliar(final NPC n) {
