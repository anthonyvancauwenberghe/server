...
public class Starter {
    ...
    public static void giveMain(final Player player) {
        for(int i = 0; i <= 6; i++){
            if(Server.SPAWN){
    ...
    public static void giveHybridPure(final Player player) {
        ...
        player.getActionSender().sendMessage("Your spellbook has been changed to ancients!");
    }

    public static void giveRangedPure(final Player player) {
    ...
    public static void giveBerserker(final Player player) {
    ...
    public static void giveSkiller(final Player player) {
        for(int i = 7; i < 23; i++){
    ...
    public static void giveStarter(final Player player) {
        final String ip = NewcomersLogging.formatIp(player.getFullIP());
        final long lastStarter = StarterLogging.getLogging().lastStarterReceived(ip);
