...
public class Combat {
    ...
    public static String canAtk(CombatEntity combatEntity, CombatEntity opponent) {
        ...
        if (LastManStanding.inLMSArea(combatEntity.getAbsX(), combatEntity.getAbsY())) {
            if (opponent != null && opponent.getEntity() instanceof Player && opponent.getPlayer() != null && opponent.getPlayer().getExtraData().getLong("combatimmunity") > System.currentTimeMillis()) {
