    ...
    protected void populate() {
        ...
        put(DungeoneeringFloorsTask.class, new TaskIO<DungeoneeringFloorsTask>() {
            ...
            public DungeoneeringFloorsTask decodeTask(final Element root, final int id, final int threshold) {
                final DungeoneeringFloorsTask.Difficulty difficulty = Optional.ofNullable(attr(root, "difficulty")).map(DungeoneeringFloorsTask.Difficulty::valueOf).orElse(null);
                final DungeoneeringFloorsTask.Size size = Optional.ofNullable(attr(root, "size")).map(DungeoneeringFloorsTask.Size::valueOf).orElse(null);
