...
public class Animation {
    ...
    public enum FacialAnimation {
         ...
         */
        private static final Map<Animation, FacialAnimation> facialAnimations = new HashMap<Animation, FacialAnimation>();

        /**
         * Populates the facial animation map.
         */
        static {
            for(final FacialAnimation facialAnimation : FacialAnimation.values()){
        ...
        FacialAnimation(final Animation animation) {
         ...
         * facial animation.
         */
        public static FacialAnimation forId(final Animation facialAnimation) {
