...
public class CombatAssistant {
	...
	public static int calculateRangeAttack(Player p) {
		...
		return (int) (((rangeAtk * .75) + p.getBonus().get(EquipmentStats.ATTACK_RANGED)/2) * .85);
	}
	...
	public static int calculateRangeDefence(Entity entity) {
		if(entity instanceof Player) {
			...
			if(player.getPrayers().isEnabled(0)) {
                ...
                rangeDef *= 1.23;
			return (int)(rangeDef * 0.75) + player.getBonus().get(EquipmentStats.DEFENCE_RANGED) / 2;
		} else //NPCs
	...
	public static int calculateMageDef(Entity entity) {
		...
		if(entity instanceof Player) {
			...
			return (int)(bonus * 1.65) + defLevel / 8 + mageLevel / 6;
		} else //NPCs
	...
	public static int calculateMeleeAttack(Player player) {
		...
		return (int) ((meleeAtk * .55 + (bonus * .7)));
	...
	public static int calculateMeleeDefence(Entity entity) {
		if(entity instanceof Player) {
			...
			return (int) (meleeDef * .55 + bonus * .7);
		} else {
